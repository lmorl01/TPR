...
-- SQL to select start and end TPR residue numbers for results

SELECT R.resultId, E.queryPdb, R.resultPdb, TPR.TPROrdinal, TPR.startResidue AS 'StartResidueQuery', TPR.endResidue AS 'EndResidueQuery', MIN(A.resultResidueNo) AS 'StartResidueResult', MAX(A.resultResidueNo) AS 'EndResidueResult'
FROM 
Results R, Experiment E, ParameterSet P, TPR, Alignment A 
WHERE
TPR.regionId = E.regionId and R.experimentId = E.experimentId and A.resultId = R.resultId 
...
E.superseded is null and TPR.superseded is null
GROUP BY
R.resultId, E.queryPdb, R.resultPdb, TPR.TPROrdinal, TPR.startResidue, TPR.endResidue
ORDER BY 
E.queryPdb, R.resultPdb, TPR.TPROrdinal;
